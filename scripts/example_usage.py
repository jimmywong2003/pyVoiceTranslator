...
from src.audio.pipeline.streaming import ResampleProcessor, NormalizeProcessor
from src.audio.benchmarking import AudioBenchmark
...
def example_5_pipeline_with_processors():
    ...
    from src.audio.pipeline.streaming import (
        PipelineConfig,
        AudioStreamingPipeline,
        ResampleProcessor,
        NormalizeProcessor,
...
def example_6_benchmarking():
    ...
    from src.audio.pipeline.streaming import AudioStreamingPipeline, PipelineConfig
...
def example_7_visualization_data():
    ...
    from src.audio.segmentation import SegmentationConfig
