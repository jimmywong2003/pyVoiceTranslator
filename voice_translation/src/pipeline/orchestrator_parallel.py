...
from audio_module.vad.silero_vad_adaptive import AdaptiveSileroVADProcessor, AdaptiveVADConfig
...
class ParallelTranslationPipeline(TranslationPipeline):
    ...
    def _create_improved_vad(self):
        ...
        from audio_module.vad.silero_vad_improved import ImprovedSileroVADProcessor
